            ...
            documents.map((doc, i) => (
              ...
              >
                <svg width="60px" viewBox="0 0 476.74 604.67">
                  ...
                  />
                  <path
                    d="M228.81,338.28V231.18c.31-.23.59-.62.87-.62,18,.19,36-.34,53.84.88,14.31,1,24.52,9.76,30.16,22.71,8.45,19.4,8.68,39.38,1.11,59.13-5.39,14.08-15.9,23.6-30.94,24.69C265.69,339.29,247.37,338.28,228.81,338.28Zm22-17.71c9.06,0,17.68.48,26.22-.13,9.17-.66,15.26-5.95,17.63-15a77.77,77.77,0,0,0,.35-39.19c-2.07-8.21-7.05-14.71-15.75-16-9.27-1.38-18.77-1.3-28.45-1.88Z"
                    transform="translate(-6.81 -5.61)"
                  />
                  <path
                    d="M127.2,231.39c19.69,0,39-1.21,58,.36,17.32,1.42,27.52,18.38,24.91,37.36-2.34,17-13.71,27.56-31.43,28.47-9.64.5-19.33.09-29.67.09V339H127.2Zm22,48.73c8.9-.47,17.34-.51,25.68-1.46,7.87-.9,12.45-6.39,12.71-13.81.27-7.74-4-14.11-11.94-15-8.63-.94-17.44-.21-26.45-.21Z"
                    transform="translate(-6.81 -5.61)"
                  />
                  <path
                    d="M339.07,230.61h74.1v18h-52v25.82H406v18.43H360.92v46H339.07Z"
                    transform="translate(-6.81 -5.61)"
                  />
                  <rect x="65.36" y="403.45" width="399.87" height="137.05" />
                </svg>
                <p style={{ fontSize: '0.707em' }}>{doc.name}</p>
              </a>
            ))}
        </Folder>
      </Cell>
